...
public class Task11 {
	public static void main(String[] args) {
		...
		double temperatureInCelsius = 36.8;
...
//		System.out.println("Celsius " + f.format(temperatureInCelsius) + "° - Kelvin " + f.format(temperatureInKelvin) + "° - Fahrenheit " + f.format(temperatureInFahrenheit) + "°");
